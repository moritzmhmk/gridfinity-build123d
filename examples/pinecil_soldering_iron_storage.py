from build123d import (Align, Axis, BuildPart, BuildSketch, Cylinder, Location,
                       Mode, Plane, Polygon, add, export_stl, extrude, fillet,
                       revolve)
...
with BuildPart(Plane.XY) as tip:
    ...
    Cylinder(radius=17/2, height=15,
